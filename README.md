...
Exact diagonalization + Metropolis-adjusted Langevin algorithm Monte Carlo sampling for a disordered Holstein model on a 2D square or 3D cubic lattice in the zero phonon frequency limit
